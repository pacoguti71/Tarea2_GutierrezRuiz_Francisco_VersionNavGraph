...
class ListadoPikminsFragment : Fragment() {
    ...
    private var _binding: FragmentListadoPikminsBinding? = null // _binding sirve para encapsular el acceso a la vista del fragmento
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = PikminAdapter(elementos) { pikminSeleccionado ->
            ...
            (requireActivity() as MainActivity).mostrarFragment(fragment)
        }
